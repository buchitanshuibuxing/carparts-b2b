...
let ImageRecognitionService = ImageRecognitionService_1 = class ImageRecognitionService {
    settingsSvc;
    logger = new common_1.Logger(ImageRecognitionService_1.name);
    constructor(settingsSvc) {
        this.settingsSvc = settingsSvc;
    }
    async recognize(imagePath) {
        const emptyResult = { oe_numbers: [], part_type: '', brand: '', part_name_cn: '', part_name_en: '', description: '', confidence: 0 };
    ...
    async recognizeWithOpenAICompatible(url, base64, mimeType, apiKey, model) {
    ...
    async recognizeWithClaude(base64, mimeType, apiKey, model) {
...
//# sourceMappingURL=image-recognition.service.js.map